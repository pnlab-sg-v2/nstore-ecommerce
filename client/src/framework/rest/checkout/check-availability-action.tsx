...
export const CheckAvailabilityAction: React.FC<React.PropsWithChildren> = ({ children, ...props }) => {
      ...
      verifyCheckout(
        {
          ...
          billing_address:
            billing_address?.address[0].id && billing_address.address,

          shipping_address:
            shipping_address?.address[0].id && shipping_address.address,
        },
        {
          onSuccess: (data) => {
